      ...
      <div className="flex-1 bg-[#E5E7EB] rounded-lg p-6 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden flex-1">
          ...
          {properties.map((property) => (
            <div
              key={property.id}
              className="grid grid-cols-6 gap-4 px-6 py-4 text-[14px] border-t items-center"
            >
              <div>
              ...
              {/* Occupancy (placeholder for tenants later) */}
              <p className="text-gray-500 text-[13px]">
                0 / {property.units}
              </p>

              <span className="inline-flex w-fit px-3 py-1 rounded-full bg-green-100 text-green-700 text-[12px]">
                Active
              </span>
